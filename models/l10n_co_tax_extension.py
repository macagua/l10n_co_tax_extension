...
class AccountInvoiceLine(models.Model):
    ...
    _description = "Model that inherit 'account.invoice.line' model from odoo core"
...
class AccountTax(models.Model):
    _name = 'account.tax'
    _description = "Model that inherit 'account.tax' model from odoo core"
...
class AccountBaseTax(models.Model):
    ...
    _description = 'Model to create and save Account Base Tax'
...
class AccountTaxGroup(models.Model):
    ...
    _description = "Model that inherit 'account.tax.group' model from odoo core"
...
class AccountFiscalPositionTaxes(models.Model):
    ...
    _description = 'Model to create and save Account Fiscal Position Taxes'
...
class AccountFiscalPosition(models.Model):
    ...
    _description = "Model that inherit 'account.fiscal.position' model from odoo core"
...
class AccountJournal(models.Model):
    ...
    _description = "Model that inherit 'account.journal' model from odoo core"
